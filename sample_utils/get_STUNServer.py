...
GEO_LOC_URL = (
    "https://raw.githubusercontent.com/pradt2/always-online-stun/master/geoip_cache.txt"  # noqa: E501
)
IPV4_URL = (
    "https://raw.githubusercontent.com/pradt2/always-online-stun/master/valid_ipv4s.txt"  # noqa: E501
)
...
def getSTUNServer():
    ...
    closest_addr, _ = min(
        map(calculate_distance, ip_addresses), key=lambda x: x[1]
    )

    # print("Free STUN Server :", closest_addr)  # prints the IP:PORT of the
    # closest STUN server
